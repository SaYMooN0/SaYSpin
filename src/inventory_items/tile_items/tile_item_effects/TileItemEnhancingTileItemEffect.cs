...
namespace SaYSpin.src.tile_item_effects
{
    ...
    {
        public TileItemsEnhancingTileItemEffect(string description, SlotMachineArea area, ModifierType modifierType, double modificationValue, Func<TileItem?, bool> condition)
            :base(description)
        {
            Area = area;
